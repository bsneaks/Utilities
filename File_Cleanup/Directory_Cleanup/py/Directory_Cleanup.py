...
parser = argparse.ArgumentParser(
    description="Clean up directory and put applicable files into their associated folders."
)
...
# parse the arguments given by the user and extract the needed path
...
#create a relative path from the path to the file and document name
...
#counter to keep track of number of moved files
